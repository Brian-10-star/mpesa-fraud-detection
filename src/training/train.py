# train.py
# The main training script. Controls the full ML pipeline:
...
def main():
    ...
    # set_experiment creates the experiment if it doesn't exist or uses the existing one if it does.
    ...
    for model_config in models:
        ...
        with mlflow.start_run(run_name=name):
            ...
            # Log hyperparameters shows what settings are used
            mlflow.log_params(params)

            # Train the model on SMOTE-balanced data
            model.fit(X_train_balanced, y_train_balanced)

            # Evaluate on the ORIGINAL unbalanced test set, this reflects real-world performance
            ...
            # This stores the actual trained model file so we can load and use it later without retraining
